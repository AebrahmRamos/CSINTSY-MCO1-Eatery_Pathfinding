...
public class Driver {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println("Select an option: 1 for Search, 2 for Add Node, 3 for Remove Node, 4 for View Node Details, 5 for View All Nodes, 6 for Connect Nodes,  7 to Exit");
            ...
            switch (option) {
                ...
                case 2 -> {
                    ...
                    int rating = -1; 
                    if (isEatery){
                        System.out.println("What is the rating of the eatery (1-5):");
                        rating = scanner.nextInt();
                    }
                    Node newNode = new Node(latitude, longitude, nodeId, isEatery, rating);
                ...
                case 6 -> {
                    ...
                    graph.addEgde(node1, node2);
                    System.out.println("Nodes connected/n");
                }
                case 7 -> {
